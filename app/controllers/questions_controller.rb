# Public: A handler for questions.
class QuestionsController < ApplicationController
  ...
  # Shifts a question up relative to it's neighbors associated with
  # the same survey
  def shift_up
    @question = Question.find(params[:id])
  ...
  # Shifts a question down relative to it's neighbors associated with
  # the same survey
  def shift_down
    @question = Question.find(params[:id])
